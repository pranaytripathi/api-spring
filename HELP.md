...
* The original package name 'org.backend.api-spring' is invalid and this project uses 'org.backend.apispring' instead.
...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/docs/3.1.1-SNAPSHOT/reference/htmlsingle/#data.nosql.mongodb)
